...
function App() {
  const movieList = [
    {
      ...
      image: "https://www.patsonic.com/wp-content/uploads/2019/09/weathering-with-you-animation-featured.jpg",
      episode: "01",
    },
    {
      id: "2",
    ...
    },
    {
      ...
      image: "https://th.bing.com/th/id/OIF.g6n2aJVWTrwnf0aau4AtVw?rs=1&pid=ImgDetMain",
      episode: "250",
    },
    {
      id: "4",
      ...
      image: "https://static2.vieon.vn/vieplay-image/thumbnail_hot_v4/2022/05/20/o2cqttkr_1920x1080-spyxfamily-demo8ce77c5eadcad47cee69c6c641f6ac9a.jpg",
      episode: "07",
    },
    {
      id: "5",
      ...
      image: "https://images-na.ssl-images-amazon.com/images/I/912upmUM3jL._RI_.jpg",
      episode: "28",
    },
    {
      id: "6",
      ...
      image: "https://animotaku.fr/wp-content/uploads/2023/03/anime-captain-tsubasa-2018-saison-2-junior-youth-arc-visuel-2.jpeg",
      episode: "28",
    },
    {
      id: "7",
      ...
      image: "https://th.bing.com/th/id/OIP.L92lzUbVpYQDVo4D92R7SwAAAA?w=400&h=563&rs=1&pid=ImgDetMain",
      episode: "28",
    },
  ];
  ...
  return (
    <div className="app-layout">
      <Header />
      <Banner currentMovie={currentMovie}/>
      <ListMovie listMovie={listMovie} setCurrentMovie={setCurrentMovie}/>
    </div>
  )
}
